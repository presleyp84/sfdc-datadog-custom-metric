...
ISSUER = '3MVG9CVKiXR7Ri5qyqIawG1qwFYXwhKsM8RXL.ngfyI.H7pHjm56j6fgxwnpR2jqzL._nv.K3Zg=='
SUBJECT = 'sysuser@sunpower.com'
...
prefix = 'https://sunpower.my.salesforce.com/services/data/v54.0/query?q='
...
query1 = query_prefix+sql_ts_15m+"-07:00"+" AND "+ "CreatedDate < "+ sql_ts_30m+"-07:00"+" AND LeadSource = 'Web' AND Source_System__c != null"
print(query1)
url1 = prefix+query1
...
query2 = query_prefix+sql_ts_30m+"-05:00"+" AND LeadSource = 'Web' AND Source_System__c != null"
print(query2)
url2 = prefix+query2
